...
CREATE TABLE `terminy` (
  ...
  `odlet_iata` varchar(3) DEFAULT NULL,
  PRIMARY KEY (`id_terminu`),
  KEY `id_zajezdu` (`id_zajezdu`),
  KEY `odlet_iata` (`odlet_iata`),
  CONSTRAINT `fk_terminy_zajezdy` FOREIGN KEY (`id_zajezdu`) REFERENCES `zajezdy` (`id_zajezdu`) ON DELETE CASCADE,
  CONSTRAINT `fk_terminy_letiste` FOREIGN KEY (`odlet_iata`) REFERENCES `letiste` (`iata`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
(9, 77, 'Hotel Regina Louvre', '/images/paris.jpg', 'Luxusní pětihvězdičkový hotel přímo naproti muzeu Louvre a zahradám Tuileries, nabízí nádherné klasické pokoje v pařížském stylu.', 31900, 'Snídaně'),
(10, 96, 'Maya Ubud Resort & Spa', '/images/bali.jpg', 'Nádherný pětihvězdičkový resort v džungli v Ubudu, s infinity bazény, luxusním spa a výhledem na údolí řeky Petanu.', 39900, 'Snídaně'),
(11, 131, 'Kuramathi Maldives Resort', '/images/maledivy.jpg', 'Nádherný resort na Maledivách s luxusními vodními vilami a korálovým útesem.', 54900, 'All Inclusive'),
(12, 215, 'Katathani Phuket Beach Resort', '/images/phuket.jpg', 'Prvotřídní plážový resort na ostrově Phuket, ideální pro relaxaci pod palmami a wellness.', 36900, 'Polopenze'),
(13, 37, 'Melia Dunas Beach Resort & Spa', '/images/kapverdy.jpg', 'Rozsáhlý all-inclusive resort na Kapverdách s písečnými plážemi a celoročním teplým mořem.', 29900, 'All Inclusive'),
(14, 55, 'Hotel Lapad Split', '/images/dalmacie.jpg', 'Krásný hotel v srdci Dalmácie, skvělá kombinace koupání v moři a poznávání památek.', 14900, 'Polopenze'),
(15, 204, 'Gran Hotel Miramar Malaga', '/images/andalusie.jpg', 'Luxusní hotel v Andalusii s úžasným výhledem na pláž a skvělou gastronomií.', 27900, 'Snídaně');

INSERT INTO `terminy` (`id_terminu`, `id_zajezdu`, `datum_od`, `datum_do`, `kapacita`, `odlet_iata`) VALUES
-- Santorini
(1, 1, '2026-07-10', '2026-07-17', 20, 'PRG'),
(2, 1, '2026-08-15', '2026-08-22', 15, 'BRQ'),
-- Kréta
(3, 2, '2026-07-20', '2026-07-27', 30, 'VIE'),
(4, 2, '2026-09-05', '2026-09-12', 25, 'PRG'),
-- Hurghada
(5, 3, '2026-10-12', '2026-10-19', 40, 'KTW'),
(6, 3, '2026-11-01', '2026-11-08', 50, 'PRG'),
-- Dubrovník
(7, 4, '2026-07-01', '2026-07-08', 12, 'PRG'),
(8, 4, '2026-08-10', '2026-08-17', 10, 'OSR'),
-- Barcelona
(9, 5, '2026-06-15', '2026-06-22', 18, 'VIE'),
(10, 5, '2026-09-20', '2026-09-27', 20, 'BTS'),
-- Positano
(11, 6, '2026-07-05', '2026-07-12', 8, 'PRG'),
(12, 6, '2026-08-01', '2026-08-08', 6, 'VIE'),
-- Paříž
(13, 9, '2026-07-01', '2026-07-08', 15, 'PRG'),
(14, 9, '2026-08-10', '2026-08-17', 20, 'BRQ'),
-- Bali
(15, 10, '2026-09-01', '2026-09-12', 10, 'VIE'),
(16, 10, '2026-10-15', '2026-10-26', 12, 'PRG'),
-- Maledivy
(17, 11, '2026-09-10', '2026-09-20', 10, 'PRG'),
(18, 11, '2026-10-01', '2026-10-15', 8, 'VIE'),
-- Phuket
(19, 12, '2026-11-05', '2026-11-15', 12, 'PRG'),
(20, 12, '2026-12-01', '2026-12-13', 15, 'VIE'),
-- Kapverdy
(21, 13, '2026-07-01', '2026-07-08', 25, 'PRG'),
(22, 13, '2026-08-10', '2026-08-24', 20, 'KTW'),
-- Dalmácie
(23, 14, '2026-06-20', '2026-06-25', 30, 'BRQ'),
(24, 14, '2026-07-15', '2026-07-22', 25, 'OSR'),
-- Andalusie
(25, 15, '2026-07-05', '2026-07-12', 18, 'PRG'),
(26, 15, '2026-09-15', '2026-09-25', 16, 'VIE');
