document.addEventListener("DOMContentLoaded", function () {
    ...
    if (filtrDestinace) filtrDestinace.addEventListener("change", filtrujZajezdy);
    ...
    var rychleVyhledavani = document.getElementById("rychle-vyhledavani");
    if (rychleVyhledavani) {
        rychleVyhledavani.addEventListener("submit", function (e) {
            e.preventDefault();
            var dest = document.getElementById("hledat-destinaci");
            if (dest && filtrDestinace) {
                filtrDestinace.value = dest.value;
                filtrujZajezdy();
            }
            var sekce = document.getElementById("zajezdy");
            if (sekce) sekce.scrollIntoView({ behavior: "smooth" });
        });
    }
